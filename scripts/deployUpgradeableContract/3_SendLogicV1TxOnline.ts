...
function readFile() {
    const path = './scripts/deployUpgradeableContract/result/2_serialized_tx.txt';
...
function writeFile(hash: string) {
    const path = './scripts/deployUpgradeableContract/result/3_V1_logic_contract_tx.json';
