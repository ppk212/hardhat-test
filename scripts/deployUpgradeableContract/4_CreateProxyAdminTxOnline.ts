...
import ProxyAdmin from "../../artifacts/contracts/transparentProxy/transparent/ProxyAdmin.sol/ProxyAdmin.json";
...
function main() {
    ...
    blockchain.createTxForDeployContract(web3, ProxyAdmin.bytecode).then(txHash => {
...
function writeFile(txHash: string) {
    const path = './scripts/deployUpgradeableContract/result/4_result.txt';
