...
function readFile() {
    const path = './scripts/deployUpgradeableContract/result/12_serialized_tx.txt';
...
function writeFile(hash: string) {
    const path = './scripts/deployUpgradeableContract/result/13_V2_logic_contract_tx.json';
